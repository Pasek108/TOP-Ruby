...
describe FindNumber do
  ...
  describe '#game_over?' do
    ...
    context 'when guess and random_number are equal' do
      ...
      subject(:guess_eight) { described_class.new(8, 8, random_number, 8) }

      it 'is game over' do
        expect(guess_eight).to be_game_over
      end
    end
    ...
    context 'when guess and random_number are not equal' do
      subject(:guess_eight) { described_class.new(7, 7, random_number, 7) }

      it 'is not game over' do
        expect(guess_eight).not_to be_game_over
      end
    end
  end
