...
describe BinaryGame do
  ...
  describe '#verify_input' do
    ...
    subject(:game_input_verify) { described_class.new(0, 10) }
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        ...
        max = 15
        value = 10
        result = game_input_verify.verify_input(min, max, value)
  ...
  describe '#maximum_guesses' do
    ...
    context 'when game minimum and maximum is 100 and 600' do
      subject(:game_100_to_600) { described_class.new(100, 600) }

      it 'returns 9' do
        max = game_100_to_600.maximum_guesses
        expect(max).to eq(9)
      end
    end
  end
  ...
  describe '#display_turn_order' do
    ...
    subject(:game_turn_order) { described_class.new(0, 10) }
    ...
    it 'increases guess_count by one' do
      count_before = game_turn_order.instance_variable_get(:@guess_count)
      game_turn_order.display_turn_order(binary_search)
      count_after = game_turn_order.instance_variable_get(:@guess_count)
