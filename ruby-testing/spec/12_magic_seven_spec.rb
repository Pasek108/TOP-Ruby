...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    context 'when random number is 69' do
      let(:magic_seven) { described_class.new(69) }

      context 'and previous number is 123' do
        it 'returns 54' do
          previous_step = 123
  ...
  describe '#play' do
    context 'when the random number is 123' do
      let(:game) { described_class.new(123) }
    ...
    context 'when the random number is 86' do
      let(:game) { described_class.new(86) }
    ...
    context 'when the random number is 0' do
      let(:game) { described_class.new(0) }
